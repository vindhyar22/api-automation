...
public class PMS_GKR_RegenerationTesting {
	...
	public void getKey() {
		...
		Response response = given().accept(ContentType.JSON).contentType(ContentType.JSON)
				.pathParam("propertyId", "e5da3911-1daa-4df8-a6fe-3dd1a0366a3f")
	...
	public void getKeyDetails() {
		...
		Response response = given().accept(ContentType.JSON).contentType(ContentType.JSON)
				.pathParam("keyId", Key_ID)
				.header("dt-property-id", "e5da3911-1daa-4df8-a6fe-3dd1a0366a3f")
