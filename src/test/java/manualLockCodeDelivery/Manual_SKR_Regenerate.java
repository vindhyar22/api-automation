...
public class Manual_SKR_Regenerate {
	...
	public void createSKR() throws Throwable {
		Thread.sleep(35000);
		System.out.println("waited for 35 sec for create skr");
	...
	public void getKeyId() {
		...
		Response response = given().accept(ContentType.JSON).contentType(ContentType.JSON).pathParam("type", "STAFF")
				.pathParam("propertyId", "e787c685-c805-4f35-bd30-316428dc5f32")
	...
	public void keyRegenerate() throws InterruptedException {
		Thread.sleep(7000);
		System.out.println("waited for 7 sec skr regenerate");
	...
	public void DeleteKeys() throws Throwable {
		// Thread.sleep(60000);
